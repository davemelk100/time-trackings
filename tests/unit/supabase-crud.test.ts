...
describe("fetchClients", () => {
  it("queries clients table, orders by name, and maps rows", async () => {
    ...
    chain._setResult([
      { id: "c1", name: "Acme", hourly_rate: 50, flat_rate: null, billing_period_start: null, billing_period_end: null, created_at: "2025-01-01" },
      { id: "c2", name: "Beta", hourly_rate: null, flat_rate: 200, billing_period_start: null, billing_period_end: null, created_at: "2025-01-01" },
    ])
    ...
    expect(result).toEqual([
      { id: "c1", name: "Acme", hourlyRate: 50, flatRate: null, billingPeriodStart: null, billingPeriodEnd: null },
      { id: "c2", name: "Beta", hourlyRate: null, flatRate: 200, billingPeriodStart: null, billingPeriodEnd: null },
    ])
  })
